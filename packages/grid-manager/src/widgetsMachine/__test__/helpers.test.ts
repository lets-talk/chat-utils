...
const isValidatePositionReferenceSpy: any = jest.spyOn(helpers, 'isValidatePositionReference')
const validateIframeWidgetWithPropsSpy: any = jest.spyOn(helpers, 'validateIframeWidgetWithProps')
...
describe('actions/helpers module', () => {
  ...
  describe('generateSortedListOfWidgets fn', () => {
    it('should be called with the correct arguments', () => {
      ...
      expect(helpers.generateSortedListOfWidgets).toBeCalledWith(widgets, rules, breakpoint)
    })
  ...
  describe('isValidatePositionReference fn', () => {
    it('should be called with the correct arguments', () => {
      ...
      isValidatePositionReferenceSpy(relation, validPositions, positionsInUse, widgetReference)
      expect(helpers.isValidatePositionReference).toBeCalledWith(relation, validPositions, positionsInUse, widgetReference)
    })
    ...
    it('should throw and error if relation is not valid', () => {
      ...
      try {
        ...
        expect(e.message).toBe('Invalid position type configuration review app settings')
    ...
    it('should return false if case is not handle yet', () => {
      ...
      const result = relation.map(v => isValidatePositionReferenceSpy(v, validPositions, positionsInUse, widgetReference))
    ...
    it('should handle relative-to-viewport as true if position is available', () => {
      ...
      const result = isValidatePositionReferenceSpy(relation, validPositions, positionsInUse, widgetReference)

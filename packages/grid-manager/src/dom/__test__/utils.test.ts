import {
  frameParentRulesMock,
  frameParentRulesMockAlternativePath,
  getPositionRelativeToAppRulesMock,
  getPositionRelativeToViewportRulesMock,
  urlSourceParamsSpec
} from '../../mocks/renderModule';
...
const getElementDomPositionMock: any = jest.spyOn(
  utilsHelpers,
  'getElementDomPosition'
);
const getElementPositionFixedMock: any = jest.spyOn(
  utilsHelpers,
  'getElementPositionFixed'
);
const getElementPositionDefaultMock: any = jest.spyOn(
  utilsHelpers,
  'getElementPositionDefault'
);
const getElementPositionMock: any = jest.spyOn(
  utilsHelpers,
  'getElementPosition'
);
const resetNodeToAbsolutePositionMock: any = jest.spyOn(
  utilsHelpers,
  'getElementPosition'
);
const generateParentContainerMock: any = jest.spyOn(
  utilsHelpers,
  'generateParentContainer'
);
const getPositionRelativeToAppMock: any = jest.spyOn(
  utilsHelpers,
  'getPositionRelativeToApp'
);
const getRelativePositionToAppMock: any = jest.spyOn(
  utilsHelpers,
  'getRelativePositionToApp'
);
const getPositionRelativeToViewportMock: any = jest.spyOn(
  utilsHelpers,
  'getPositionRelativeToViewport'
);
const getRelativePositionMock: any = jest.spyOn(
  utilsHelpers,
  'getRelativePosition'
);
const generateUrlFromParamsMock: any = jest.spyOn(
  utilsHelpers,
  'generateUrlFromParams'
);
const generateDomElementMock: any = jest.spyOn(
  utilsHelpers,
  'generateDomElement'
);
const appendNodeToParentMock: any = jest.spyOn(
  utilsHelpers,
  'appendNodeToParent'
);
...
describe('module: dom/utils', () => {
    ...
    it('should throw an error if the element it doesn`t exit ', async () => {
      ...
      try {
        ...
        expect(e).toStrictEqual(
          Error('Can not find the dom element with id: otherId')
        );
      }
    });
  });
  ...
  describe('getElementPositionDefault method', () => {
    ...
    it('It should return the correct dimensions ', () => {
      const result = getElementPositionDefaultMock('someIds', {
        scrollY: 100,
        scrollX: 100
      });
  ...
  describe('serializeBorderRadius method', () => {
    ...
    it('should return a string literal if the css value is passed', () => {
      const result = utilsHelpers.serializeBorderRadius(
        '10px 10px 10px 10px',
        false
      );
  ...
  describe('generateParentContainer method', () => {
    it('it should be called with the correct arguments', () => {
      ...
      expect(generateParentContainerMock).toBeCalledWith(
        'someClass',
        frameParentRulesMock,
        null
      );
    ...
    it('it should return a dom node with the passed rules', () => {
      const result = generateParentContainerMock(
        'someClass',
        frameParentRulesMock,
        null
      );
  ...
  describe('getPositionRelativeToApp method', () => {
    it('should be called with the correct arguments', () => {
      ...
      expect(getPositionRelativeToAppMock).toBeCalledWith(
        getPositionRelativeToAppRulesMock
      );
    });

    it('it should return a dom node with the passed rules', () => {
      const result = getPositionRelativeToAppMock(
        getPositionRelativeToAppRulesMock
      );
  ...
  describe('getRelativePositionToApp method', () => {
    it('it should be called with the correct number of arguments', () => {
      ...
      expect(getRelativePositionToAppMock).toBeCalledWith(
        size,
        parentSize,
        offset
      );
  ...
  describe('getPositionRelativeToViewport method', () => {
    ...
    it('should be called with the correct arguments', () => {
      ...
      expect(getPositionRelativeToViewportMock).toBeCalledWith(
        getPositionRelativeToViewportRulesMock
      );
    });
    it('should return the correct css props', () => {
      const result = getPositionRelativeToViewportMock(
        getPositionRelativeToViewportRulesMock
      );
      expect(result).toStrictEqual({
        border: '1px solid red',
  ...
  describe('generateUrlFromParams method', () => {
    it('should be called with the correct arguments', () => {
      ...
      expect(generateUrlFromParamsMock).toBeCalledWith(
        urlSourceParamsSpec,
        'slugKey'
      );
    });
